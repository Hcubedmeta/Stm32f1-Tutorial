...
extern "C" {
	...
	#define	CSX_PORT	PA
    #define CSX_PIN		2 //Chip select
	#define RESX_PORT	PA
    #define RESX_PIN	3 //Reset pin
	#define	CMD_PORT	PA
    #define CMD_PIN		1 //Command select
    ...
    void drawTriangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t x3, uint16_t y3, uint16_t color,int thickness);
