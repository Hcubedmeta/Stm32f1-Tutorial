...
void lcd_i2c_msg(char i2c, unsigned char line_1_2, unsigned char pos_0_16, char msg[])
{
	...
	switch(line_1_2)
	{
		...
		case 4: // Dòng 4
			...
			break;
		default:
			return; // N?u dòng không h?p l?, thoát kh?i hàm
	}
...
{
	lcd_i2c_msg(i2c, 1, 0, "                    "); // Xóa 20 ký t?
}

void lcd_blank_2(char i2c)
{
	lcd_i2c_msg(i2c, 2, 0, "                    "); // Xóa 20 ký t?
}

void lcd_blank_3(char i2c)
{
	lcd_i2c_msg(i2c, 3, 0, "                    "); // Xóa 20 ký t?
}

void lcd_blank_4(char i2c)
{
	lcd_i2c_msg(i2c, 4, 0, "                    "); // Xóa 20 ký t?
}

void lcd_blank_1234(char i2c)
{
	lcd_blank_1(i2c);
	lcd_blank_2(i2c);
	lcd_blank_3(i2c);
